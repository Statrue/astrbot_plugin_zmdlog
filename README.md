...
| `/zmdlog 角色 <关键词>` | 某个榜单的六星角色 DPS 分布 |
| `/zmdlog 角色 [关键词] --范围 <7d\|14d\|30d\|all> --潜能 <0\|1-5\|all>` | 限定统计的时间范围与角色潜能 |
| `/zmdlog 阵容 <关键词> [--top <数量>]` | 某个榜单的职业位出场率与前 N 名常见阵容 |
...
- `角色` / `阵容` 只针对具体榜单；关键词命中副本或系列时会给出该副本下的榜单候选，引用回复序号即可。危机合约不提供角色统计。
